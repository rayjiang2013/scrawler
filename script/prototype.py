                ...
                try:
                    ...
                    if datetime.now().strftime('%Y-%m-%d %H:%M:%S') > start_time:
                        ...
                        if volumes[stock][-1] in outliers:
                            ...
                            send_email("l_jiang_icloud@apple.com", "l_jiang_icloud@gmail.com", high_volume_message, "")
                            requests.post(sms_server, {
                                'number': phone_number,
                            ...
                            if is_low_price(price, prices[stock]):
                                ...
                                send_email("l_jiang_icloud@apple.com", "l_jiang_icloud@gmail.com", low_price_message, "")
                                requests.post(sms_server, {
                                    'number': phone_number,
                                ...
                                high_price_message = "High price notification for %s. Current price is: %s; time is: %s" % (
                                    stock, price, extended_price_time)
                                send_email("l_jiang_icloud@apple.com", "l_jiang_icloud@gmail.com", high_price_message, "")
                                requests.post(sms_server, {
                                    'number': phone_number,
